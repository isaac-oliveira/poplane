    ...
    if (!supported) {
      ...
      if (!regex) {
        if (value.apk && value.aab) {
          io.warn("You passed the '--apk' and '--aab' flags, this will be considered the default lane value")
        }
        if (value.ios && value.android) {
          io.warn("If you want to build a version for both platforms, you can omit the '--android' and '--ios' flags")
        }
