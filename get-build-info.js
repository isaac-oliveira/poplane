...
const main = () => {
  ...
  const versionInfo = foundRegexInFile(iosInfoplistFile, iosInfoplist.version, '$1')
  const buildNumberInfo = foundRegexInFile(iosInfoplistFile, iosInfoplist.buildNumber, '$1')
